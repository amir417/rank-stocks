...
const Navbar = () => {
  ...
  return (
      <>
        <NavbarWrapper>
          <NavTitle>Rank Stocks</NavTitle>
          <NavbarComponent>
            <NavLink title="home" to="/" style={{textDecoration: 'none'}}><NavFont>Home</NavFont></NavLink>
            <NavLink title="about" to="/about" style={{textDecoration: 'none'}}><NavFont>About</NavFont></NavLink>
            <NavLink title="login" to="/login" style={{textDecoration: 'none'}}><NavFont>Login</NavFont></NavLink>
            <NavLink title="join" to="/join" style={{textDecoration: 'none'}}><NavFont>Join</NavFont></NavLink>
          </NavbarComponent>
          ...
          ? <SidebarWrapper>
              ...
              <br/>
              <NavLink title="home" to="/" style={{textDecoration: 'none'}}><NavFont>Home</NavFont></NavLink>
              <NavLink title="logout" to="/login" style={{textDecoration: 'none'}
              // need to add onClick feature
              }><NavFont>Logout</NavFont></NavLink>
            </SidebarWrapper> 
          : <></>}
        </NavbarWrapper>
      </>
